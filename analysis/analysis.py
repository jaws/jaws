...
parser.add_argument('plot', help = 'plot type', type = str)
...
if args.plot == 'diurnal':
	...
	seasonal()
	plt.errorbar(months, var_month_avg, yerr = var_month_sd, fmt='--o', ecolor= 'lightskyblue', color='k', capthick=5, snap=True)
	plt.xticks(months)
	plt.xlabel('Month')
