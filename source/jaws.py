...
def Main():
	...
	station_dict = {
		...
		'gcnet_petermanngl': [80.68361, 60.29305, 'Petermann Gl.',],
		'gcnet_petermanela': [80.08305, 58.07277, 'Peterman ELA',],
		...
		'aaws_mountsiple': [-70.700, 44.290, 'Mount Siple'],
		'aaws_nico': [-89.000, 90.024, 'Nico'],
		'aaws_pandasouth': [-82.325, 75.989, 'PANDA-South'],
		'aaws_pegasusnorth': [-82.325, 75.989, 'Pegasus North'],
